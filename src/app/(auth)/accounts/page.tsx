            ...
            <div className="max-w-5xl mx-auto w-full space-y-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <p className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-[0.3em] mb-1">Tesouraria</p>
                            <h1 className="text-3xl font-heading font-bold text-slate-900 dark:text-white tracking-tight">Gestão de Bancas</h1>
                        </div>
                    </div>
                        ...
                        <Card className="rounded-[2.5rem] border border-slate-200/60 dark:border-slate-800/60 shadow-2xl bg-white dark:bg-slate-900/40 backdrop-blur-md overflow-hidden relative">
                            ...
                            <CardHeader className="p-10 pb-6 border-b border-slate-100 dark:border-slate-800/50 relative z-10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-2xl font-heading font-bold text-slate-900 dark:text-white tracking-tight">
                                        {editingAccount ? 'Editar Configurações' : 'Configurar Nova Banca'}
                                    </CardTitle>
                                </div>
                                <CardDescription className="text-slate-500 dark:text-slate-400 font-bold uppercase text-[10px] tracking-widest mt-2">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <Input
                                                    ...
                                                    className="h-14 pl-12 rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/30 font-bold text-sm focus:ring-blue-500 transition-all"
                                                />
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] ml-1">Moeda Base</label>
                                            <div className="relative group">
                                                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 pointer-events-none z-10" />
                                                <Select value={currency} onValueChange={setCurrency}>
                                                    <SelectTrigger className="h-14 pl-12 rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/30 font-bold text-sm focus:ring-blue-500 transition-all text-slate-900 dark:text-white">
                                                        <SelectValue />
                                                    </SelectTrigger>
                                                    <SelectContent className="rounded-2xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
                                                        <SelectItem value="USD" className="font-bold py-3 text-sm">Dólar (USD)</SelectItem>
                                                        <SelectItem value="BRL" className="font-bold py-3 text-sm">Real (BRL)</SelectItem>
                                                        <SelectItem value="EUR" className="font-bold py-3 text-sm">Euro (EUR)</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] ml-1">Saldo de Partida</label>
                                            <div className="relative group">
                                                ...
                                                <Input
                                                    ...
                                                    className="h-14 pl-12 rounded-2xl border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/30 font-bold text-sm focus:ring-blue-500 transition-all font-mono"
                                                />
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {accounts.map((acc: any, index: number) => (
                        ...
                        >
                            ...
                            <div className="p-10 flex justify-between items-start relative z-10">
                                <div className="space-y-8 flex-1">
                                    <div className="flex items-center gap-4">
                                        <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800/80 rounded-[2rem] flex items-center justify-center text-slate-900 dark:text-white group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 shadow-sm border border-slate-100 dark:border-slate-700/50">
                                            <Wallet className="h-8 w-8" />
                                        </div>
                                        <div>
                                            <h3 className="text-2xl font-heading font-black text-slate-900 dark:text-white tracking-tight leading-none mb-1.5">{acc.name}</h3>
                                            <div className="flex items-center gap-2">
                                                <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-400 text-[10px] font-black uppercase tracking-[0.1em] rounded-md border border-slate-200/50 dark:border-slate-700">
                                                    {acc.currency}
                                                </span>
                                                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Conta Principal</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="space-y-2">
                                        <p className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.3em] ml-1">Saldo Atual</p>
                                        <p className="text-4xl md:text-5xl font-heading font-black text-slate-900 dark:text-white tracking-tighter">
                                ...
                                <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end" className="rounded-2xl border-slate-200 dark:border-slate-800 shadow-2xl bg-white dark:bg-slate-950 p-3 min-w-[200px]">
                                            <DropdownMenuItem onClick={() => startEditing(acc)} className="rounded-xl font-bold uppercase text-[10px] tracking-widest cursor-pointer py-3 px-4 focus:bg-slate-50 dark:focus:bg-slate-900 mb-1">
                                                <Pencil className="h-4 w-4 mr-3 text-blue-500" /> Editar Definições
                                            </DropdownMenuItem>
                                            <DropdownMenuItem onClick={() => openDeleteConfirm(acc)} className="rounded-xl font-bold uppercase text-[10px] tracking-widest text-red-600 focus:text-red-700 dark:text-red-400 dark:focus:text-red-300 cursor-pointer py-3 px-4 focus:bg-red-50 dark:focus:bg-red-900/20">
                            ...
                            <div className="bg-slate-50/50 dark:bg-slate-800/20 px-10 py-5 border-t border-slate-100 dark:border-slate-800/50 flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-slate-400/80 relative z-10">
                                <div className="flex items-center gap-2">
                ...
                <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                    <DialogContent className="rounded-[3rem] p-10 max-w-md border-none shadow-2xl bg-white dark:bg-slate-950">
                        <DialogHeader className="space-y-8">
                            ...
                            <div className="space-y-3">
                                <DialogTitle className="text-3xl font-heading font-black text-center text-slate-900 dark:text-white tracking-tight">Encerrar Conta?</DialogTitle>
                                <DialogDescription className="text-center text-slate-500 dark:text-slate-400 font-bold text-lg leading-relaxed">
                        ...
                        <DialogFooter className="flex-col sm:flex-row gap-4 mt-10">
                            <Button
                                ...
                                className="flex-1 h-14 rounded-2xl font-black text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 uppercase tracking-widest text-xs"
                            >
                                CANCELAR
                            </Button>
                            <Button
                                ...
                                disabled={submitting}
                                className="flex-1 h-14 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-black tracking-widest uppercase text-xs shadow-xl shadow-red-500/20"
                            >
