...
export function Topbar({ user }: TopbarProps) {
    ...
    return (
        <header className="h-14 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0b1220] flex items-center justify-between px-4 z-30 relative shrink-0">
